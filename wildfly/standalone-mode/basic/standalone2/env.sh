...
export JBOSS_HOME=/home/jooho/Applications/EAP/jboss-eap-6.1
export DOMAIN_BASE=/home/jooho/Applications/EAP_TEST/611
export SERVER_NAME=ClusterTest_Standalone2
...
export JAVA_OPTS=" $JAVA_OPTS -Djboss.server.name=$SERVER_NAME"
